...
fn part1(c: &mut Criterion) {
    benchmark::<Parser, Solver1>(c, "part 1");
}

fn part2(c: &mut Criterion) {
    benchmark::<Parser, Solver2>(c, "part 2");
}
